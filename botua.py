...
user_ads["buy"] = [
    ad("@CryptoBoss",   41.6, "500 – 2000 грн", banks("Monobank", "PrivatBank", "PUMB", "A-Bank", "Sense Bank"), t="buy"),
    ad("@UkrTrader",    41.6, "500 – 2000 грн", banks("Monobank", "Sense Bank", "Ukrsibbank", "Concord Bank"), t="buy"),
    ad("@BestRate24",   41.78, "500 – 2000 грн", banks("PrivatBank", "PUMB", "OTP Bank", "Oschadbank", "Raiffeisen"), t="buy"),
    ad("@FastUSDT",     41.48, "500 – 2000 грн", banks("Monobank", "PUMB", "MTB Bank", "Globus Bank"), t="buy"),
    ad("@TrustExchanger",41.89, "500 – 2000 грн", banks("Raiffeisen", "Sense Bank", "PrivatBank", "Ukrsibbank", "Oschadbank"), t="buy"),
    ad("@VerifedPro",   41.76, "500 – 2000 грн", banks("Monobank", "PrivatBank", "A-Bank", "Credit Agricole"), t="buy"),
    ad("@TetherKing",   41.68, "500 – 2000 грн", banks("Monobank", "PrivatBank", "PUMB", "Raiffeisen"), t="buy"),
    ad("@CashToCoin",   41.92, "500 – 2000 грн", banks("PrivatBank", "PUMB", "Ukrsibbank", "Concord Bank"), t="buy"),
    ad("@EasyChange",   41.63, "500 – 2000 грн", banks("Monobank", "PrivatBank", "PUMB", "MTB Bank"), t="buy"),
    ad("@USDTbanker",   42.15, "2000 – 6000 грн", banks("Raiffeisen", "PrivatBank", "Sense Bank", "Monobank", "Globus Bank", "Tascombank"), t="buy"),
    ad("@ExchangePlus", 42.15, "2000 – 6000 грн", banks("Monobank", "PrivatBank", "PUMB", "Oschadbank", "Ukrsibbank"), t="buy"),
    ad("@BitProfi",     42.18, "2000 – 6000 грн", banks("Monobank", "PrivatBank", "PUMB", "Oschadbank", "OTP Bank", "Credit Agricole"), t="buy"),
    ad("@FiatBridge",   42.20, "2000 – 6000 грн", banks("Monobank", "PrivatBank", "Sense Bank", "Ukrsibbank"), t="buy"),
    ad("@DigitalGate",  42.21, "2000 – 6000 грн", banks("PrivatBank", "PUMB", "Raiffeisen", "Sense Bank", "Oschadbank"), t="buy"),
    ad("@FastMoney",    42.29, "2000 – 6000 грн", banks("Monobank", "PrivatBank", "PUMB", "Raiffeisen", "Sense Bank"), t="buy"),
    ad("@TokenExpress", 42.26, "2000 – 6000 грн", banks("PrivatBank", "PUMB", "Oschadbank", "Ukrsibbank", "Concord Bank", "Globus Bank"), t="buy"),
    ad("@FixRate",      42.23, "2000 – 6000 грн", banks("Monobank", "PrivatBank", "PUMB", "A-Bank", "Sense Bank", "OTP Bank"), t="buy"),
    ad("@UkrUSDT",      42.27, "2000 – 6000 грн", banks("Monobank", "PrivatBank", "PUMB", "Raiffeisen", "Oschadbank"), t="buy"),
    ad("@MonoCrypto",   42.61, "6000 – 40000 грн", banks("PrivatBank", "PUMB", "Oschadbank", "Tascombank", "Credit Agricole", "MTB Bank"), t="buy"),
    ad("@VerifiedX",    42.68, "6000 – 40000 грн", banks("Monobank", "PrivatBank", "PUMB", "Raiffeisen", "Sense Bank", "Ukrsibbank", "Concord Bank", "Globus Bank"), t="buy"),
    ad("@RateMaster",   42.70, "6000 – 40000 грн", banks("PrivatBank", "PUMB", "Oschadbank", "Ukrsibbank", "OTP Bank", "Credit Agricole"), t="buy"),
    ad("@FixSpread",    42.62, "6000 – 40000 грн", banks("Monobank", "PrivatBank", "PUMB", "Raiffeisen", "Sense Bank"), t="buy"),
    ad("@UAChanger",    42.66, "6000 – 40000 грн", banks("Monobank", "PrivatBank", "PUMB", "Ukrsibbank", "Concord Bank"), t="buy"),
    ad("@DeepRate",     42.69, "6000 – 40000 грн", banks("PrivatBank", "PUMB", "Oschadbank", "Ukrsibbank", "Concord Bank", "Globus Bank"), t="buy"),
    ad("@NightTrader",  42.64, "6000 – 40000 грн", banks("Monobank", "PrivatBank", "PUMB", "Raiffeisen", "Oschadbank"), t="buy"),
]
