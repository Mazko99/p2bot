...
API_TOKEN = "8303303900:AAFInPBw69MoNgcyECbV_3s3XuGq8NYGXLU"
...
user_ads["buy"] = [
    ad("@CryptoBossRU", 81.30, "500 – 2000 ₽", banks("Сбербанк", "Тинькофф", "Альфа-Банк"), t="buy"),
    ad("@USDT_Russia",  71.50, "500 – 2000 ₽", banks("ВТБ", "Газпромбанк", "ЮMoney", "Альфа-Банк"), t="buy"),
    ad("@TetherSellRU", 78.80, "500 – 2000 ₽", banks("Киви Банк", "Росбанк", "Сбербанк"), t="buy"),
    ad("@Dima",         78.80, "500 – 2000 ₽", banks("Киви Банк", "Росбанк", "Сбербанк"), t="buy"),
    ad("@Crypto",       79.40, "500 – 2000 ₽", banks("Киви Банк", "Росбанк", "Сбербанк"), t="buy"),
    ad("@Evgen",        81.25, "500 – 2000 ₽", banks("Киви Банк", "Тинькофф", "Росбанк", "Сбербанк"), t="buy"),
    ad("@Pingu",        81.25, "500 – 2000 ₽", banks("Киви Банк", "Росбанк", "Сбербанк", "Тинькофф"), t="buy"),
    ad("@FastChangeRU", 81.10, "2000 – 6000 ₽", banks("Сбербанк", "Тинькофф", "Альфа-Банк", "Райффайзен"), t="buy"),
    ad("@RU_CryptoPay", 81.35, "2000 – 6000 ₽", banks("Газпромбанк", "ВТБ", "Совкомбанк"), t="buy"),
    ad("@TetherDealer", 81.75, "2000 – 6000 ₽", banks("Сбербанк", "Тинькофф", "ЮMoney", "Киви Банк"), t="buy"),
    ad("@timurp2p",     81.75, "2000 – 6000 ₽", banks("Росбанк","ВТБ","Сбербанк", "Тинькофф", "ЮMoney", "Киви Банк"), t="buy"),
    ad("@SellCrypto24", 82.00, "6000 – 40000 ₽", banks("Альфа-Банк", "Совкомбанк", "Райффайзен"), t="buy"),
    ad("@USDTMarketRU", 83.20, "6000 – 40000 ₽", banks("Сбербанк", "Газпромбанк", "Тинькофф", "ЮMoney"), t="buy"),
    ad("@RU_USDTline",  82.45, "6000 – 40000 ₽", banks("Росбанк", "Совкомбанк", "ВТБ", "Киви Банк"), t="buy"),
    ad("@TetherBankRU", 83.60, "6000 – 40000 ₽", banks("Сбербанк", "Альфа-Банк", "ЮMoney", "Тинькофф"), t="buy"),
]
user_ads["sell"] = [
    ad("@CryptoBossRU", 81.30, "500 – 2000 ₽", banks("Сбербанк", "Тинькофф", "Альфа-Банк"), t="buy"),
    ad("@USDT_Russia",  71.50, "500 – 2000 ₽", banks("ВТБ", "Газпромбанк", "ЮMoney", "Альфа-Банк"), t="buy"),
...
async def open_order(call: types.CallbackQuery, state: FSMContext):
    ...
    await call.message.answer("💰 Введите сумму в рублях, которую хотите обменять:")
...
async def ad_set_amount(message: types.Message, state: FSMContext):
    ...
    await message.answer("💰 Введите курс в ₽ (например: 83.12):")
...
async def ad_set_rate(message: types.Message, state: FSMContext):
    ...
    await message.answer("🏦 Укажите банки через запятую (например: ЮMoney,Альфа-Банк,Raiffeisen Bank):")
...
async def order_enter_amount(message: types.Message, state: FSMContext):
    ...
    if not amount_rub.replace(".", "").isdigit():
        return await message.answer("⚠️ Введите число в рублях (например: 1500).")
